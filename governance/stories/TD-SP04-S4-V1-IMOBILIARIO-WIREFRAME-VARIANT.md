...
| AC-11 Art. I CLI First | ✅ | `revisor imobiliario validate --matricula --valor --garantia --indice` |
| AC-12 Zero regression baseline ≥425 | ⚠️ Pendente Oracle G5 empirical run |
